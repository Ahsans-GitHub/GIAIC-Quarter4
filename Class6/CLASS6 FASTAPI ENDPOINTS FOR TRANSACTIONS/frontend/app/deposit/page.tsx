...
export default function Deposit() {
  ...
  const handleDeposit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.detail || data.message || "Deposit failed");
      }
      ...
      setError(err.message || "An unknown error occurred during deposit.");
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h1 className="text-2xl font-bold mb-6 text-center">Deposit / Send Money</h1>
        <form onSubmit={handleDeposit}>
          ...
          <div className="mb-4">
            <label htmlFor="senderPin" className="block text-gray-700 text-sm font-bold mb-2">
              Your PIN:
            </label>
            <input
              type="password"
          ...
          <div className="mb-4">
            <label htmlFor="recipientPhone" className="block text-gray-700 text-sm font-bold mb-2">
